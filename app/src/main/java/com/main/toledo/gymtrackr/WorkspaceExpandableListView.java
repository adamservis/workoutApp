...
public class WorkspaceExpandableListView extends animatedExpandableListView {
    ...
    private boolean[] mExpansionMemory;
    ...
    private WorkspaceExpandableListAdapterMKIII.dragListener mListener = new WorkspaceExpandableListAdapterMKIII.dragListener(){
        ...
        public void OnDragHandleLongClickedListener(View selectView, int type){
            ...
            if(type == PACKED_POSITION_TYPE_CHILD){
                ...
                //selectView.findViewById(R.id.circuitFooter).setVisibility(VISIBLE);
                Log.d(logTag, "Should make footer visibile");
                selectView.findViewById(R.id.circuitFooter).setVisibility(VISIBLE);
                /*
                ...
                for(int i = 0; i<numCircuits; i++){
                    ...
                    Log.d(logTag, "isGroupExpanded(" + i + ") returned " + expanded);
